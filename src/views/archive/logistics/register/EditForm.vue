  ...
  <div>
    ...
    >
      ...
      >
        <el-row :gutter="20">
          <el-col :span="6">
            <el-form-item label="快递单号:" prop="expressNo" :rules="[{required: true}]">
              <el-input
          ...
          <el-col :span="8">
            <el-form-item class="express-com" label="快递公司:" prop="expressCompany" :rules="[{required: true}]">
              <el-select
          ...
          <el-col :span="5">
            <el-form-item label="寄送/接收:" prop="postOrReceive" :rules="[{required: true}]">
              <el-select
        ...
        <div class="address-info">
          <el-row :gutter="20">
            ...
            <el-col :span="20">
              <el-row :gutter="20"> 
                ...
                <el-col :span="8">
                  <el-form-item label="寄件人联系方式:" label-width="120px" prop="postPhone">
                    <el-input
          ...
          <el-row :gutter="20">
            <el-col :span="3" class="recipient-avatar">
              <div class="recipient-icon">收</div>
            </el-col>
            <el-col :span="20">
              <el-row :gutter="20"> 
                <el-col :span="8">
                ...
                <el-col :span="8">
                  <el-form-item label="收件人联系方式:" label-width="120px" prop="recipientPhone">
                    <el-input
        ...
        <el-row style="margin-top: 20px;">
          <el-col :span="5">
            <el-form-item label="快递状态:" prop="postOrReceive" :rules="[{required: true}]">
              <el-select
                v-model="basicInfoForm.postOrReceiveStatus"
                style="width: 100%"
                clearable
          ...
          <el-col >
            <el-form-item label="快递内容:" prop="expressContentList">
              <el-table
                ...
                row-key="id"
              >
              <el-table-column label="序号" prop="number" width="180" align="center"/>
              <el-table-column label="快递内容编号" prop="expressContentNo" width="180" align="center"/>
              <el-table-column label="快递内容类型" prop="expressContentType" width="180" align="center"/>
              <el-table-column label="类型对应编号" prop="typeNo" width="180" align="center"/>
              <el-table-column label="关联合同号" prop="contractNo" width="180" align="center"/>
        ...
        <el-row :gutter="20">
          <el-col >
            <el-form-item label="附件:" prop="otherInfoList">
              <div style="margin-bottom: 20px;"><el-button type="primary">上传</el-button></div>
              <el-table
              ...
              >
              <el-table-column label="序号" prop="number" width="180" align="center"/>
              <el-table-column label="文件名" prop="expressContentNo" width="180" align="center"/>
              <el-table-column label="上传用户" prop="expressContentType" width="180" align="center"/>
              <el-table-column label="上传时间" prop="typeNo" width="180" align="center"/>
